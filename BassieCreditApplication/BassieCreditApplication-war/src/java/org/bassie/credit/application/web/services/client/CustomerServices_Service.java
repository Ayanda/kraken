 ...
 * 
 */
@WebServiceClient(name = "CustomerServices", targetNamespace = "http://services.web.customerservice.org/", wsdlLocation = "http://localhost:8080/CustomerService/CustomerServices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICES_QNAME = new QName("http://services.web.customerservice.org/", "CustomerServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CustomerService/CustomerServices?wsdl");
    ...
    public CustomerServices getCustomerServicesPort() {
        return super.getPort(new QName("http://services.web.customerservice.org/", "CustomerServicesPort"), CustomerServices.class);
    }
    ...
    public CustomerServices getCustomerServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.web.customerservice.org/", "CustomerServicesPort"), CustomerServices.class, features);
    }
